...
export class ProviderService {
  ...
  headers() {
    return new HttpHeaders().set('simple','9450476b384b32d8ad8b758e76c98a69').set('authorization',this._localstorage.getItem('user') == null ? '':this._localstorage.getItem('user').token);
  }
